...
path = 'C:/Users/zero/Desktop/MovieRecommend/data/movies.csv'# 更改路径
...
config = dict(
    username='zero', password='12345',address='localhost', 
...
con = engine.connect()
df.to_sql(name='Items_Movies', con=con, if_exists='append', index=False)
